...
CREATE TABLE IF NOT EXISTS USERS (
    ...
    CONSTRAINT fk_users_families FOREIGN KEY (family_id) REFERENCES FAMILIES (family_id) ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS INCOME (
    ...
    CONSTRAINT fk_income_users FOREIGN KEY (user_id) REFERENCES USERS (user_id) ON DELETE SET NULL
    );
